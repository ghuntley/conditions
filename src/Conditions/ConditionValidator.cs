...
namespace Conditions
{
    ...
    /// <example>
    /// The following example shows how to use <b>Conditions</b>.
    /// <code><![CDATA[
    ...
    public abstract class ConditionValidator<T>
    {
        ...
        [SuppressMessage("Microsoft.Design", "CA1051:DoNotDeclareVisibleInstanceFields", Justification =
            ...
            "have to worry about extra method calls.")] [SuppressMessage("Microsoft.Security", "CA2104:DoNotDeclareReadOnlyMutableReferenceTypes",
                Justification = "The rule is correct. We tried to make ConditionValidator<T> immutable, but " +
                                ...
                                "enough to be sure that the value or the reference to the value won't change.")] public readonly T Value;
