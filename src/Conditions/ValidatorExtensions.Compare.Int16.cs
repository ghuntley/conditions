...
namespace Conditions
{
    ...
    public static partial class ValidatorExtensions
    {
        ...
        public static ConditionValidator<short> IsInRange(this ConditionValidator<short> validator, short minValue,
            short maxValue)
        {
        ...
        public static ConditionValidator<short> IsNotInRange(this ConditionValidator<short> validator, short minValue,
            short maxValue)
        {
            short value = validator.Value;
        ...
        public static ConditionValidator<short> IsNotGreaterThan(this ConditionValidator<short> validator,
            short maxValue)
        {
        ...
        public static ConditionValidator<short> IsGreaterOrEqual(this ConditionValidator<short> validator,
            short minValue)
        {
            if (!(validator.Value >= minValue))
            {
