...
namespace Conditions
{
    ...
    public static partial class ValidatorExtensions
    {
        ...
        public static ConditionValidator<string> IsShorterOrEqual(this ConditionValidator<string> validator,
            int maxLength)
        {
            string value = validator.Value;
        ...
        public static ConditionValidator<string> IsLongerOrEqual(this ConditionValidator<string> validator,
            int minLength)
        {
            string value = validator.Value;
        ...
        public static ConditionValidator<string> DoesNotStartWith(this ConditionValidator<string> validator,
            string value)
        {
