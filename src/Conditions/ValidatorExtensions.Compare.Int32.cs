...
namespace Conditions
{
    ...
    public static partial class ValidatorExtensions
    {
        ...
        public static ConditionValidator<int> IsInRange(this ConditionValidator<int> validator, int minValue,
            int maxValue)
        {
        ...
        public static ConditionValidator<int> IsNotInRange(this ConditionValidator<int> validator, int minValue,
            int maxValue)
        {
            int value = validator.Value;
