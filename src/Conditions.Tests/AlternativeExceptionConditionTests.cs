...
namespace Conditions.Tests
{
    ...
    public class AlternativeExceptionConditionTests
    {
        [TestMethod]
        [Description(
            "WithExceptionOnFailure called multiple times with the same exception type, always returns the same instance."
            )]
        ...
        [TestMethod]
        [Description(
            "WithExceptionOnFailure called multiple times with the different exception type, always returns different instances."
            )]
        ...
        [Description(
            "WithExceptionOnFailure called with an abstract exception type throws an exception of type ArgumentException."
            )]
        ...
        [TestMethod]
        [Description(
            "WithExceptionOnFailure called with an invalid exception throws an exception with the expected message.")]
        ...
        [TestMethod]
        [Description(
            "WithExceptionOnFailure called with an invalid exception throws an exception with the expected parameter name."
            )]
        ...
        [Description(
            "WithExceptionOnFailure called with a valid exception throws that same type in case of a validation failure."
            )]
