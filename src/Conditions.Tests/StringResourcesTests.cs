...
namespace Conditions.Tests
{
    ...
    public class StringResourcesTests
    {
        ...
        [TestMethod]
        [Description(
            "This test validates whether the defined string consts in the SR class have a value that equals it's name.")
        ]
        public void TestMethod01()
        {
            Assert.IsNotNull(SrType, "The type SR could not be found in the Conditions assembly.");
        ...
        [TestMethod]
        [Description(
            "This test validates whether the const string fields of the SR class reference an existing string resource."
            )]
