...
namespace Conditions.Tests.StringTests
{
    ...
    public class StringIsNotNullOrWhiteSpaceTests
    {
        ...
        [TestMethod]
        [Description(
            "Calling a failing IsNotNullOrWhiteSpace should throw an Exception with an exception message that contains the given parameterized condition description argument."
            )]
