...
namespace Conditions.Tests.StringTests
{
    ...
    public class StringIsNullOrWhiteSpaceTests
    {
        ...
        [TestMethod]
        [Description(
            "Calling a failing IsNullOrWhiteSpace should throw an Exception with an exception message that contains the given parameterized condition description argument."
            )]
