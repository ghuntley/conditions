...
namespace Conditions.Tests.CompareTests
{
    ...
    public class CompareGenericTests
    {
        ...
        [Description(
            "Calling IsInRange on System.Enum x with 'lower bound < x > upper bound' should fail with an ArgumentException."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling IsNotInRange on IComparable<T> object with 'lower bound > null < upper bound' should pass.")]
        ...
        [ExpectedException(typeof (System.ArgumentException))]
        [Description(
            "Calling IsNotInRange on Enum with 'lower bound < x > upper bound' should fail with an ArgumentException.")]
        ...
        [ExpectedException(typeof (System.ArgumentException))]
        [Description(
            "Calling IsNotGreaterOrEqual on Enum x with 'x = upper bound' should fail with an ArgumentException.")]
        ...
        [ExpectedException(typeof (ArgumentNullException))]
        [Description(
            "Calling IsNotEqualTo on Nullable<int> x = null with 'x = x' should fail with ArgumentNullException.")]
