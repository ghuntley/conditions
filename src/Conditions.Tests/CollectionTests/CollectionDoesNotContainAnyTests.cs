...
namespace Conditions.Tests.CollectionTests
{
    ...
    public class CollectionDoesNotContainAnyTests
    {
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAny on a null collection with a null reference as 'any' collection should pass.")]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAny on an empty collection with a null reference as 'any' collection should pass.")]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAny on a filled collection with a null reference as 'any' collection should pass.")]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAny on a null collection with an empty collection as 'any' collection should pass.")]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAny on an empty collection with an empty collection as 'any' collection should pass."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAny on a filled collection with an empty collection as 'any' collection should pass."
            )]
        ...
        [Description(
            "Calling DoesNotContainAny with a 'any' collection containing all elements of the tested collection should fail."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling DoesNotContainAny with a 'any' collection containing one element of the tested collection should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAny with a 'any' collection containing no element of the tested collection should pass."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling DoesNotContainAny with an non-generic 'any' collection containing one element of the tested typed collection should fail."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling DoesNotContainAny with an non-generic 'any' collection containing one element of the tested non-generic collection should fail."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling DoesNotContainAny with an non-generic 'any' collection containing one element of different types of the tested non-generic collection should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAny with an non-generic 'any' collection containing no elements of the tested typed collection should pass."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAny with an non-generic 'any' collection containing no elements of the tested non-generic collection should pass."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAny with an non-generic 'any' collection containing no elements of different types of the tested non-generic collection should pass."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAny on a generic collection with the condtionDescription parameter should pass.")]
        ...
        [TestMethod]
        [Description(
            "Calling a failing DoesNotContainAny with a generic collection should throw an Exception with an exception message that contains the given parameterized condition description argument."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAny on a non-generic collection with the condtionDescription parameter should pass.")
        ]
        ...
        [TestMethod]
        [Description(
            "Calling a failing DoesNotContainAny with a non-generic collection should throw an Exception with an exception message that contains the given parameterized condition description argument."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling the generic DoesNotContainAny with an element that's not in the list while enumerating it, should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling the non-generic DoesNotContainAny with an element that's not in the list while enumerating it, should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAny with a 'any' collection containing all elements of the tested collection should succeed when exceptions are suppressed."
            )]
