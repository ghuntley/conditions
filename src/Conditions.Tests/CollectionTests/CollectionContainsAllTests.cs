...
namespace Conditions.Tests.CollectionTests
{
    ...
    public class CollectionContainsAllTests
    {
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAll on a null collection with an empty collection as 'all' collection should pass.")]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAll on an empty collection with an empty collection as 'all' collection should pass.")]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAll on a filled collection with an empty collection as 'all' collection should pass.")]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAll with a 'all' collection containing all elements of the tested collection should pass.")
        ]
        ...
        [Description(
            "Calling ContainsAll with a 'all' collection containing one element of the tested collection should fail.")]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling ContainsAll with a 'all' collection containing no element of the tested collection should fail.")]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAll with an non-generic 'all' collection containing all elements of the tested typed collection should pass."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAll with an non-generic 'all' collection containing all elements of the tested non-generic collection should pass."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAll with an non-generic 'all' collection containing all elements of different types of the tested non-generic collection should pass."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling ContainsAll with an non-generic 'all' collection containing not all elements of the tested typed collection should fail."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling ContainsAll with an non-generic 'all' collection containing all elements of the tested non-generic collection should fail."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling ContainsAll with an non-generic 'all' collection containing not all elements of different types of the tested non-generic collection should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling a failing ContainsAll with a generic collection should throw an Exception with an exception message that contains the given parameterized condition description argument."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAll on a non-generic collection with the condtionDescription parameter should pass.")]
        ...
        [TestMethod]
        [Description(
            "Calling a failing ContainsAll with a non-generic collection should throw an Exception with an exception message that contains the given parameterized condition description argument."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling ContainsAll on non-empty collection that doesn't contain a null value with a 'all' collection that does contain the value null should fail."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling ContainsAll on non-empty non-generic collection that doesn't contain a null value with a 'all' collection that does contain the value null should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling the generic ContainsAll with an element that's not in the list while enumerating it, should fail.")
        ]
        ...
        [TestMethod]
        [Description(
            "Calling the non-generic ContainsAll with an element that's not in the list while enumerating it, should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAll with a 'all' collection containing no element of the tested collection should succeed when exceptions are suppressed."
            )]
