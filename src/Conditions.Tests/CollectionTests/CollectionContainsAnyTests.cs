...
namespace Conditions.Tests.CollectionTests
{
    ...
    public class CollectionContainsAnyTests
    {
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling ContainsAny on an empty collection with an empty collection as 'any' collection should fail.")]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling ContainsAny on a filled collection with an empty collection as 'any' collection should fail.")]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAny with a 'any' collection containing all elements of the tested collection should pass.")
        ]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAny with a 'any' collection containing one element of the tested collection should pass.")]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling ContainsAny with a 'any' collection containing no element of the tested collection should fail.")]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAny with an non-generic 'any' collection containing one element of the tested typed collection should pass."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAny with an non-generic 'any' collection containing one element of the tested non-generic collection should pass."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAny with an non-generic 'any' collection containing one element of different types of the tested non-generic collection should pass."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling ContainsAny with an non-generic 'any' collection containing no elements of the tested typed collection should fail."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling ContainsAny with an non-generic 'any' collection containing no elements of the tested non-generic collection should fail."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling ContainsAny with an non-generic 'any' collection containing no elements of different types of the tested non-generic collection should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAny with an two collections that implement IEnumerable<T> but not IColletion<T> should pass."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling a failing ContainsAny with a generic collection should throw an Exception with an exception message that contains the given parameterized condition description argument."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAny on a non-generic collection with the condtionDescription parameter should pass.")]
        ...
        [TestMethod]
        [Description(
            "Calling a failing ContainsAny with a non-generic collection should throw an Exception with an exception message that contains the given parameterized condition description argument."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAny on a collection containing a null value with an 'any' collection also containing a null value should succeed."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling the generic ContainsAny with an element that's not in the list while enumerating it, should fail.")
        ]
        ...
        [TestMethod]
        [Description(
            "Calling the non-generic ContainsAny with an element that's not in the list while enumerating it, should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAny with an self-referencing collection should not lead to an StackOverflowException.")]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAny on a null collection with a null reference as 'any' collection should succeed when exceptions are suppressed."
            )]
