...
namespace Conditions.Tests.CollectionTests
{
    ...
    public class CollectionDoesNotContainTests
    {
        ...
        [TestMethod]
        [Description(
            "Calling a failing generic DoesNotContain should throw an exception with an exception message containing the supplied parameterized condition description."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling the non-generic DoesNotContain with an optional condition description parameter should pass.")]
        ...
        [TestMethod]
        [Description(
            "Calling a failing non-generic DoesNotContain should throw an exception with an exception message containing the supplied parameterized condition description."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling the generic DoesNotContain with an element that's not in the list while enumerating it, should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling the non-generic DoesNotContain with an element that's not in the list while enumerating it, should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContain on an Collection that contains the tested value should succeed when exceptions are suppressed."
            )]
