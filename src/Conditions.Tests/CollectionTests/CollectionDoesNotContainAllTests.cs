...
namespace Conditions.Tests.CollectionTests
{
    ...
    public class CollectionDoesNotContainAllTests
    {
        ...
        [Description(
            "Calling DoesNotContainAll on a null collection with a null reference as 'any' collection should fail.")]
        ...
        [Description(
            "Calling DoesNotContainAll on an empty collection with a null reference as 'any' collection should fail.")]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling DoesNotContainAll on a filled collection with a null reference as 'any' collection should fail.")]
        ...
        [ExpectedException(typeof (ArgumentNullException))]
        [Description(
            "Calling DoesNotContainAll on a null collection with an empty collection as 'any' collection should fail.")]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling DoesNotContainAll on an empty collection with an empty collection as 'any' collection should fail."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling DoesNotContainAll on a filled collection with an empty collection as 'any' collection should fail."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling DoesNotContainAll with a 'any' collection containing all elements of the tested collection should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAll with a 'any' collection containing one element of the tested collection should pass."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAll with a 'any' collection containing no element of the tested collection should pass."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling DoesNotContainAll with an non-generic 'all' collection containing all elements of the tested typed collection should fail."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling DoesNotContainAll with an non-generic 'all' collection containing all elements of the tested non-generic collection should fail."
            )]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling DoesNotContainAll with an non-generic 'all' collection containing all elements of different types of the tested non-generic collection should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAll with an non-generic 'all' collection containing not all elements of the tested typed collection should pass."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAll with an non-generic 'all' collection containing all elements of the tested non-generic collection should pass."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling ContainsAll with an non-generic 'all' collection containing not all elements of different types of the tested non-generic collection should pass."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAll on a generic collection with the condtionDescription parameter should pass.")]
        ...
        [TestMethod]
        [Description(
            "Calling a failing DoesNotContainAll with a generic collection should throw an Exception with an exception message that contains the given parameterized condition description argument."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAll on a non-generic collection with the condtionDescription parameter should pass.")
        ]
        ...
        [TestMethod]
        [Description(
            "Calling a failing DoesNotContainAll with a non-generic collection should throw an Exception with an exception message that contains the given parameterized condition description argument."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling the generic DoesNotContainAll with an element that's not in the list while enumerating it, should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling the non-generic DoesNotContainAll with an element that's not in the list while enumerating it, should fail."
            )]
        ...
        [TestMethod]
        [Description(
            "Calling DoesNotContainAll on a null collection with a null reference as 'any' collection should succeed when exceptions are suppressed."
            )]
