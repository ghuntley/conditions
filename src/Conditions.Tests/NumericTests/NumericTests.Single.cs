...
namespace Conditions.Tests.NumericTests
{
    ...
    public partial class NumericSingleTests
    {
        ...
        [TestMethod]
        [Description(
            "Calling IsPositiveInfinity on Single x with x positive infinity and conditionDescription should pass.")]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling IsPositiveInfinity on Single x with x negative infinity and conditionDescription should fail.")]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling IsNotPositiveInfinity on Single x with positive infinity and conditionDescription should fail.")]
        ...
        [TestMethod]
        [Description(
            "Calling IsNegativeInfinity on Single x with x negative infinitiy and conditionDescription should pass.")]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling IsNegativeInfinity on Single x with x positive infinity and conditionDescription should fail.")]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling IsNotNegativeInfinity on Single x with x negative infinity and conditionDescription should fail.")]
