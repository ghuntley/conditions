...
namespace Conditions.Tests.NumericTests
{
    ...
    public partial class NumericDoubleTests
    {
        ...
        [TestMethod]
        [Description(
            "Calling IsPositiveInfinity on Double x with x positive infinity and conditionDescription should pass.")]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling IsPositiveInfinity on Double x with x negative infinity and conditionDescription should fail.")]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling IsNotPositiveInfinity on Double x with positive infinity and conditionDescription should fail.")]
        ...
        [TestMethod]
        [Description(
            "Calling IsNegativeInfinity on Double x with x negative infinitiy and conditionDescription should pass.")]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling IsNegativeInfinity on Double x with x positive infinity and conditionDescription should fail.")]
        ...
        [ExpectedException(typeof (ArgumentException))]
        [Description(
            "Calling IsNotNegativeInfinity on Double x with x negative infinity and conditionDescription should fail.")]
